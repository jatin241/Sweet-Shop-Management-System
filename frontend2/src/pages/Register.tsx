...
import { Mail, Lock, User, Candy, ArrowRight } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast({
        ...
        description: `Account created for ${user.name || user.email}`,
      });
        ...
        <Card className="glass-morphism border-white/20 shadow-candy">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              Create your account and start managing sweets
            </p>
          </CardHeader>
